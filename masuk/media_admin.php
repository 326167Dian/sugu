						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($canAccessUjian) { ?><li><a href="?module=ujian"><i class="glyphicon glyphicon-list-alt"></i> Ujian</a></li><?php } ?>
								</ul>
							</li>
							<li class="treeview">
								<a href="#">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['level'] == "pemilik" || $_SESSION['level'] == "petugas") { ?><li><a href="?module=lapstokopname"><i class='glyphicon glyphicon-print'></i> Stok Opname</a></li><?php } ?>
									<?php if ($_SESSION['level'] == "pemilik") { ?><li><a href="?module=rekapkeprofesian"><i class='glyphicon glyphicon-print'></i> Rekapan Administratif Keprofesian</a></li><?php } ?>
								</ul>
							</li>
