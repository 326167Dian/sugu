...
// input ditampilkan dalam format rupiah (mis. "41.180"), jadi titik ribuan harus dibuang dulu
// sebelum dipakai sebagai angka -- kalau tidak, PHP membaca "41.180" sebagai 41.18 (titik desimal)
$hrgsat_dtrbmasuk    = str_replace('.', '', $_POST['hrgsat_dtrbmasuk']);
...
try {
    ...
    if ($trbmasuk->rowCount() > 0) {
        $hrgbelidisc = $hrgsat_dtrbmasuk * (1 - ($detail['diskon'] / 100));
