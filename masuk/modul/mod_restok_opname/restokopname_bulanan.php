...
?>
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Re-Stok Opname Bulanan</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date">
                                    ...
                                    <select name='tgl_awal' id='tgl_awal' class='form-control'>";
                                        <?php
                                        $tampil = $db->prepare("SELECT tgl_stokopname, SUM(selisih) as ttl_selisih
                                                    FROM stok_opname
                                                    WHERE tgl_stokopname >= DATE_SUB(CURRENT_DATE(), INTERVAL 3 MONTH)
                                                    GROUP BY tgl_stokopname
                                                    ORDER by tgl_stokopname DESC;");
                                        $tampil->execute();
                                        while ($rk = $tampil->fetch(PDO::FETCH_ASSOC)) {
                                            echo "<option value='$rk[tgl_stokopname]'>$rk[tgl_stokopname]</option>";
                                        }
                                        ?>
                                    </select>
            ...
            <script>
                ...
                function tampil() {
                    ...
                    // window.location = 'modul/mod_lapstok/stokopname_excel.php?jenisobat='+jenisobat
                    window.open('?module=restokopname&act=tampil&jenisobat=' + jenisobat + '&tgl=' + tgl_awal, '_blank');
                }
            </script>
        ...
        ?>
            ...
            <script>
                ...
                function simpan_stok_opname(param) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: 'modul/mod_restok_opname/simpan_restokopname.php',
                        data: {
                            'id_barang': id_barang,
                            'kd_barang': kd_barang,
                ...
                function hapus_stok_opname(param) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: 'modul/mod_restok_opname/hapus_restokopname.php',
                        data: {
                            'id_stok': id_stok
                        },
                        success: function(response) {
                ...
                function tabel_stokopname() {
                    ...
                    $.ajax({
                        url: 'modul/mod_restok_opname/tabel_restokopname_bulanan.php',
                        type: 'post',
                        data: {
                            'tgl_awal': tgl_awal,
                            'jenisobat': jenisobat,
                ...
                function tabel_stokopname_rekap() {
                    ...
                    $.ajax({
                        url: 'modul/mod_restok_opname/tabel_restokopname_rekap_bulanan.php',
                        type: 'post',
                        data: {
                            'tgl_awal': tgl_awal,
                            'jenisobat': jenisobat
